...
public class Ripple extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.ripple_view_color, getResources().getColor(R.color.rippelColor));
        rippleType = typedArray.getInt(R.styleable.ripple_view_type, 0);
        hasToZoom = typedArray.getBoolean(R.styleable.ripple_view_zoom, false);
        isCentered = typedArray.getBoolean(R.styleable.ripple_view_centered, false);
        rippleDuration = typedArray.getInteger(R.styleable.ripple_view_rippleDuration, rippleDuration);
        frameRate = typedArray.getInteger(R.styleable.ripple_view_framerate, frameRate);
        rippleAlpha = typedArray.getInteger(R.styleable.ripple_view_alpha, rippleAlpha);
        ripplePadding = typedArray.getDimensionPixelSize(R.styleable.ripple_view_ripplePadding, 0);
        canvasHandler = new Handler();
        zoomScale = typedArray.getFloat(R.styleable.ripple_view_zoomScale, 1.03f);
        zoomDuration = typedArray.getInt(R.styleable.ripple_view_zoomDuration, 200);
        typedArray.recycle();
        paint = new Paint();
    ...
    public interface OnRippleCompleteListener {
        void onComplete(Ripple rippleView);
    }
}
